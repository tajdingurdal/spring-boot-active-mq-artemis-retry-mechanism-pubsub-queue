...
* The original package name 'com.active-mq' is invalid and this project uses 'com.active_mq' instead.
...
* [Spring for Apache ActiveMQ 5](https://docs.spring.io/spring-boot/3.3.7/reference/messaging/jms.html#messaging.jms.activemq)
